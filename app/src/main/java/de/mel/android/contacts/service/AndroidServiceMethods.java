...
public class AndroidServiceMethods {
    ...
    private final MelService service;
    private final AndroidContactSettings androidContactSettings;
    private ContentObserver observer;

    public AndroidServiceMethods(MelService service, ContactsDatabaseManager databaseManager, AndroidContactSettings androidContactSettings) {
