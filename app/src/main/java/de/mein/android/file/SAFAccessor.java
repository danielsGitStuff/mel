...
public class SAFAccessor {
    ...
    public static Promise<Void, Exception, Void> setupAllStorages(MeinActivity activity) {
...
//    }
    ...
    @androidx.annotation.RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public static Promise<Void, Exception, Void> askForInternalRootDirectory(MeinActivity activity) {
        DeferredObject<Void, Exception, Void> deferred = new DeferredObject<>();
