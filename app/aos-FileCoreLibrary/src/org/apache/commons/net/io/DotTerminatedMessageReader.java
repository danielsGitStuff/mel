...
public final class DotTerminatedMessageReader extends BufferedReader
{
     ...
     * @exception java.io.IOException If an error occurs while reading the underlying
     *            stream.
     */
    @Override
     ...
     * @exception java.io.IOException If an error occurs in reading the underlying
     *            stream.
     */
    @Override
     ...
     * @exception java.io.IOException  If an error occurs while reading the
     *            underlying stream.
     */
    @Override
