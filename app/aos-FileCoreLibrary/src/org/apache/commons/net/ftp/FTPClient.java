 ...
 * {@link Util#copyStream(java.io.InputStream, java.io.OutputStream, int, long, CopyStreamListener, boolean)}
 ...
 * @see org.apache.commons.net.ftp.FTP
...
implements Configurable
{
     ...
     * The entries are the systemType (as determined by {@link org.apache.commons.net.ftp.FTPClient#getSystemType})
     * and the values are the replacement type or parserClass, which is passed to
     * {@link org.apache.commons.net.ftp.parser.FTPFileEntryParserFactory#createFileEntryParser(String)}.<br/>
     * For example:
     * <pre>
     * Plan 9=Unix
     ...
     *         the connection.
     * @exception java.io.IOException  If an I/O error occurs while either sending a
     ...
     * @throws java.net.UnknownHostException if the ipAddress cannot be resolved
     * @since 2.2
     */
