...
public class TelnetClient extends Telnet
{
     ...
     * <p>
     * @exception java.io.IOException  If an error occurs during connection setup.
     ***/
    @Override
     ...
     * {@link org.apache.commons.net.telnet.TelnetClient} will add the IAC SB &amp; IAC SE framing bytes;
     ...
     * @throws java.io.IOException if an I/O error occurs while writing the message
     * @since 3.0
     ***/
     ...
     * by {@link java.io.InputStream#available}) transitions from zero to non-zero.
